...
###Survival model. Cluster and statistical analysis is then performed using k-means and chi-square
...
img_channels = 1
# data
Outcomes_file = '/home/chintan/Desktop/AhmedData/StageISurvival.csv' #define the outcomes file, sorted according to PID
path1 = '/home/chintan/Desktop/AhmedData/StageISurvival' #change this to only test images    
...
Outcome_of_interest = pd.Series.as_matrix(Outcomes.loc[:,'HIST3TIER']) #surv2yrTC, STAGE1_2, HIST3TIER
