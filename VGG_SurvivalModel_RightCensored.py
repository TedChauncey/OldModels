...
for layer in model.layers[:11]:  # layer 11 has best performance? 15 or 11 or 6 or 3  
...
Outcomes_file = '/home/chintan/Desktop/MLPlayGround/Augmented_Set_Exp/TrainO_RightCensored.csv' #define the outcomes file, sorted according to PID
path1 = '/home/chintan/Desktop/MLPlayGround/Augmented_Set_Exp/RightCensored_Train'    #path of folder of images    
path2 = '/home/chintan/Desktop/MLPlayGround/Augmented_Set_Exp/TrainImageCrops' #path of folder to save images    
...
#save model 
fname = "VGG_SurvivalModel_RightCensored_run2.h5"
model.save(fname)
